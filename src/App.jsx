  ...
  return (
    <div className="app">
      ...
      <main id="top">
        ...
        {/* Credential strip */}
        <section className="section section--credentials" aria-label="Quick stats">
          <div className="shell">
            <Reveal>
      ...
      <footer className="site-footer">
        <div className="shell site-footer__inner">
          <div className="site-footer__brand">
            <span className="site-header__mark" aria-hidden="true">AS</span>
            <span className="site-footer__name">Austin Stickley</span>
            <span className="site-footer__role">AI Product Engineer</span>
          </div>

          <nav className="site-footer__links" aria-label="Social links">
            <a href="https://github.com/astickleyid" target="_blank" rel="noreferrer" aria-label="GitHub">
              <IconGithub size={18} />
              <span>GitHub</span>
            </a>
            <a href="https://linkedin.com/in/austinstickley" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              <IconLinkedin size={18} />
              <span>LinkedIn</span>
            </a>
            <a href="mailto:astickleyid@gmail.com" aria-label="Email">
              <span>astickleyid@gmail.com</span>
            </a>
          </nav>

          <p className="site-footer__copy">
            &copy; {new Date().getFullYear()} Austin Stickley &mdash; Built with React, Vite &amp; Motion
          </p>
        </div>
      </footer>
    </div>
