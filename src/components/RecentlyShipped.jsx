...
export const shippedItems = [
  ...
  { project: 'VOID RIFT', feature: 'Pilot XP progress bar on game-over screen — XP earned per run with animated level progress fill', shippedAt: '2026-07-28T00:00:00.000Z' },
  { project: 'Rival', feature: 'Snapshot diff panel on competitor detail — recent page changes per scrape run, plus fix for 24h briefing filter', shippedAt: '2026-07-26T00:00:00.000Z' },
  { project: 'Rival', feature: 'Inline competitor editing — name, website, pricing & changelog URLs editable after creation', shippedAt: '2026-07-25T00:00:00.000Z' },
  { project: 'Rival', feature: 'Upgrade-gate card for competitor limit — Starter plan shows locked UI with upgrade CTA when limit reached', shippedAt: '2026-07-23T00:00:00.000Z' },
  { project: 'Rival', feature: 'Billing section in Settings — Stripe portal link with live plan status and trial countdown', shippedAt: '2026-07-22T00:00:00.000Z' },
  { project: 'VOID RIFT', feature: 'Per-stat PB labels on game-over banner — shows which stats (kills, time, accuracy) hit new personal bests', shippedAt: '2026-07-21T00:00:00.000Z' },
  { project: 'VOID RIFT', feature: 'Per-stat PB tracking on game-over — animated gold PB badges for kills, time survived, accuracy', shippedAt: '2026-07-19T00:00:00.000Z' },
  { project: 'Rival', feature: 'Public /pricing page — feature comparison, $49/mo plan, trial CTA with full pricing breakdown', shippedAt: '2026-07-18T00:00:00.000Z' },
  { project: 'Rival', feature: 'Post-checkout success toast — welcome banner on ?checkout=success redirect from Stripe', shippedAt: '2026-07-17T00:00:00.000Z' },
  { project: 'VOID RIFT', feature: 'Mission-complete toast popup — standalone center-screen notification on mission completion', shippedAt: '2026-07-16T00:00:00.000Z' },
  { project: 'VOID RIFT', feature: 'Mobile touch controls overhaul — prioritized touch play, safe areas, performance on iOS', shippedAt: '2026-07-16T00:00:00.000Z' },
  { project: 'VOID RIFT', feature: 'HERALD OF VOID boss at VOID SURGE wave 15 — multi-phase swarm commander with phase transitions and elite burst', shippedAt: '2026-07-15T00:00:00.000Z' },
